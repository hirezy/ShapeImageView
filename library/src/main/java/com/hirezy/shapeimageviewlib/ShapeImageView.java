...
public class ShapeImageView extends AppCompatImageView {
    ...
    public ShapeImageView(Context context, AttributeSet attr, int defStyle) {
        ...
        mPendingScaleType = ShapeScaleType.getType(a.getInt(R.styleable.ShapeImageView_Hirezy_shapeScaleType, 0));
        mAutoCropHeightWidthRatio = a.getFloat(R.styleable.ShapeImageView_Hirezy_autoCrop_height_width_ratio, 2f);
        float radius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_radius, 0);
        leftTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_left_top_radius, radius);
        leftBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_left_bottom_radius, radius);
        rightTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_right_top_radius, radius);
        rightBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_right_bottom_radius, radius);

        startTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_start_top_radius, radius);
        startBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_start_bottom_radius, radius);
        endTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_end_top_radius, radius);
        endBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_end_bottom_radius, radius);

        shapeType = ShapeType.getType(a.getInt(R.styleable.ShapeImageView_Hirezy_shape, 1));
        bgShapeType = ShapeType.getType(a.getInt(R.styleable.ShapeImageView_Hirezy_shape_border, 0));
        ColorStateList startColor = a.getColorStateList(R.styleable.ShapeImageView_Hirezy_shape_border_startColor);
        ColorStateList centerColor = a.getColorStateList(R.styleable.ShapeImageView_Hirezy_shape_border_centerColor);
        ColorStateList endColor = a.getColorStateList(R.styleable.ShapeImageView_Hirezy_shape_border_endColor);
        bgShapeColor = a.getColorStateList(R.styleable.ShapeImageView_Hirezy_shape_border_color);
        gradientAngle = a.getFloat(R.styleable.ShapeImageView_Hirezy_shape_border_angle, 0);
        gradientRtlAngle = a.getBoolean(R.styleable.ShapeImageView_Hirezy_shape_border_rtl_angle, false);
        isGradient = a.getBoolean(R.styleable.ShapeImageView_Hirezy_shape_border_gradient, false);
        mBgPaintWidth = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_width, 1);
        float bgRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_radius, 0);
        bgLeftTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_left_top_radius, bgRadius);
        bgLeftBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_left_bottom_radius, bgRadius);
        bgRightTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_right_top_radius, bgRadius);
        bgRightBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_right_bottom_radius, bgRadius);

        bgStartTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_start_top_radius, bgRadius);
        bgStartBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_start_bottom_radius, bgRadius);
        bgEndTopRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_end_top_radius, bgRadius);
        bgEndBottomRadius = a.getDimension(R.styleable.ShapeImageView_Hirezy_shape_border_end_bottom_radius, bgRadius);
