...
public class AlmightyShapeImageView extends AppCompatImageView {
    ...
    public AlmightyShapeImageView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mShapeResource = a.getDrawable(R.styleable.AlmightyShapeImageView_Hirezy_almighty_shape_resource);
        mShapeScaleType = ShapeScaleType.getType(a.getInt(R.styleable.AlmightyShapeImageView_Hirezy_almighty_shape_scaleType, 0));
        a.recycle();
